...
public:
    ...
    void AsyncBackprop(const ComputationNodeBasePtr rootNode, AsyncFun backpropAggFun);
...
protected:
    ...
    public:
        ...
        virtual void Backprop(const FrameRange& fr, bool childrenInThisLoop, bool childrenInOuterLoop) override;
        virtual void AsyncBackprop(const FrameRange& fr, AsyncFun backpropAggFun) override;
        virtual void RequestMatricesBeforeForwardProp(MatrixPool& matrixPool);
        virtual void ReleaseMatricesAfterForwardProp(MatrixPool& matrixPool);
        virtual void AllocateGradientMatricesForInputs(MatrixPool& matrixPool);
        virtual void RequestMatricesBeforeBackprop(MatrixPool& matrixPool);
